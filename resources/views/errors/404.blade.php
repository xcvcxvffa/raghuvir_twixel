...
<!-- Header End -->
    ...
    <div class="page-header bg-section dark-section parallaxie" data-image="{{ \App\Models\PageBanner::getImage('404') }}" style="background-image: url('{{ \App\Models\PageBanner::getImage('404') }}') !important;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
