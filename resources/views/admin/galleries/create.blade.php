...
@section('title', 'Add New Media Item - Raghuvir Atta')
...
<div class="breadcrumb-nav" style="margin-bottom: 0.85rem;">
    ...
    <i class="fa-solid fa-chevron-right"></i>
    <span class="current">Add New Media</span>
</div>
...
<div class="gallery-hero-header">
    <div class="gallery-hero-title-box">
        ...
        <div>
            <h1 class="gallery-page-title">Add Gallery Media</h1>
            <p class="gallery-page-subtitle">
                Upload a high-resolution photograph or embed a YouTube video to feature in Raghuvir Atta's public showcases.
            </p>
        </div>
    </div>
...
<!-- Main Form Container -->
<form action="{{ route('admin.galleries.store') }}" method="POST" enctype="multipart/form-data" id="createMediaForm">
    @csrf
    ...
    <div class="gallery-form-card">
        <div class="gallery-form-header">
            ...
            <div>
                <h3 class="table-card-title">Media Details &amp; Upload</h3>
                <p class="table-card-desc">Choose between a photo upload or YouTube video embed, and set categorization.</p>
            </div>
        </div>
        ...
        <div class="gallery-form-body">
            ...
            <div class="form-group-wrap">
                ...
                <div class="media-type-switch-grid">
                    <label class="media-type-option" id="typeOptionImage">
                        <input type="radio" name="type" value="image" {{ old('type', 'image') === 'image' ? 'checked' : '' }} onchange="updateTypeFields()">
                    ...
                    <label class="media-type-option" id="typeOptionVideo">
                        <input type="radio" name="type" value="video" {{ old('type') === 'video' ? 'checked' : '' }} onchange="updateTypeFields()">
                        <div class="type-card-inner">
            ...
            <div class="form-row-2col">
                ...
                <div class="form-group-wrap">
                    ...
                    <input
                        ...
                        value="{{ old('category', 'Factory & Milling') }}"
                    >
            ...
            <div id="videoUrlGroup" class="form-group-wrap" style="display: none;">
                ...
                <div id="videoUploadSubGroup" style="display: block;">
                    <div class="dropzone-area" id="videoDropzoneArea" onclick="document.getElementById('video_file').click()">
                        ...
                        <div id="videoDropzonePlaceholder">
                            ...
                            <div class="dropzone-title">Click to upload video file or drag &amp; drop here</div>
                ...
                <div id="videoUrlSubGroup" style="display: none;">
            ...
            <!-- 4. Image Upload & Drag-Drop Field -->
            <div class="form-group-wrap">
                <label class="form-field-label">
                    <span id="imageLabel">High-Resolution Photo File <span style="color: #ef4444;">*</span></span>
                </label>
                ...
                <div class="dropzone-area" id="dropzoneArea" onclick="document.getElementById('image').click()">
                    ...
                    <div id="dropzonePlaceholder">
                        ...
                        <div class="dropzone-title">Click to upload photo or drag &amp; drop file here</div>
                        <div class="dropzone-subtitle">Supported: JPG, PNG, WEBP, SVG (Max 5MB)</div>
                    </div>
                    <div id="dropzonePreviewWrap" style="display: none;">
                        ...
                        <div style="margin-top: 0.75rem;">
                            <button type="button" class="gallery-btn gallery-btn-outline" style="padding: 4px 12px; font-size: 0.75rem;" onclick="event.stopPropagation(); resetUploadImage();">
                                <i class="fa-solid fa-trash-can" style="color: #ef4444;"></i> Remove &amp; Choose Another
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <div class="form-row-2col" style="padding-top: 1rem; border-top: 1px solid var(--border); align-items: center;">
                ...
                <div class="form-group-wrap" style="margin: 0;">
                    ...
                    <label class="custom-toggle-wrap">
                        ...
                        <span class="custom-toggle-label">Publish live on website immediately</span>
                    </label>
                </div>
            </div>
        </div>
...
<style>
    /* =========================================================================
       COMPLETE SELF-CONTAINED SYNDRON UI STYLES FOR CREATE VIEW
       ========================================================================= */
    .gallery-hero-header {
        display: flex;
...
<script>
    function updateTypeFields() {
        ...
        if (isVideo) {
            ...
            imageLabel.innerHTML = 'High-Resolution Photo File <span style="color: #ef4444;">*</span>';
    ...
    // Form Submit Validation: Prevent submitting without required image or video file
    document.getElementById('createMediaForm').addEventListener('submit', function(e) {
        ...
        if (type === 'image') {
            ...
            if (!imageInput.files || imageInput.files.length === 0) {
                ...
                if (!alertBox) {
                    ...
                    alertBox.innerHTML = '<i class="fa-solid fa-circle-exclamation"></i> Photo asset requires a file. Please click the box above to select and upload an image.';
