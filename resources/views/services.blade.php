...
<!-- Header End -->
    ...
    <div class="page-header bg-section dark-section parallaxie" data-image="{{ \App\Models\PageBanner::getImage('services') }}" style="background-image: url('{{ \App\Models\PageBanner::getImage('services') }}') !important; background-position: {{ \App\Models\PageBanner::getPosition('services') }} !important;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
            ...
            <div class="row service-item-list">
                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <div class="service-item wow fadeInUp" data-wow-delay="0.8s">
                        <div class="icon-box">
                            <img src="{{ asset('images/icon-services-5.svg') }}" alt="">
                        </div>
                        <div class="services-item-body">
                            <div class="services-item-content">
                                <h2><a href="{{ route('service-details') }}">Organic Crop Production</a></h2>
                                <p>We focus on delivering clean, naturally grown crops along with services that encourage</p>
                            </div>
                            <div class="services-item-btn">
                                <a href="{{ route('service-details') }}" class="readmore-btn">Read More</a>
                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <div class="service-item wow fadeInUp" data-wow-delay="1s">
                        <div class="icon-box">
                            <img src="{{ asset('images/icon-services-6.svg') }}" alt="">
                        </div>
                        <div class="services-item-body">
                            <div class="services-item-content">
                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <div class="service-item wow fadeInUp" data-wow-delay="1.2s">
                        <div class="icon-box">
                            <img src="{{ asset('images/icon-services-7.svg') }}" alt="">
                        </div>
                        <div class="services-item-body">
                            <div class="services-item-content">
                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <div class="service-item wow fadeInUp" data-wow-delay="1.4s">
                        <div class="icon-box">
                            <img src="{{ asset('images/icon-services-8.svg') }}" alt="">
                        </div>
                        <div class="services-item-body">
                            <div class="services-item-content">
                                <h2><a href="{{ route('service-details') }}">Seed & Plant Nursery</a></h2>
                                <p>We focus on delivering clean, naturally grown crops along with services that encourage</p>
                            </div>
                            <div class="services-item-btn">
                                <a href="{{ route('service-details') }}" class="readmore-btn">Read More</a>
